...
class LandscapesControllerTest < ActionController::TestCase
  ...
  test "should create landscape" do
    assert_difference('Landscape.count') do
      post :create, landscape: { description: @landscape.description, photo: @landscape.photo, title: @landscape.title }
    end
  ...
  test "should update landscape" do
    patch :update, id: @landscape, landscape: { description: @landscape.description, photo: @landscape.photo, title: @landscape.title }
    assert_redirected_to landscape_path(assigns(:landscape))
  end
