...
class TrailsControllerTest < ActionController::TestCase
  ...
  test "should create trail" do
    assert_difference('Trail.count') do
      post :create, trail: { introduction: @trail.introduction, location: @trail.location, name: @trail.name }
    end
  ...
  test "should update trail" do
    patch :update, id: @trail, trail: { introduction: @trail.introduction, location: @trail.location, name: @trail.name }
    assert_redirected_to trail_path(assigns(:trail))
  end
